...
<head>
    ...
    <title>Iniciar Sesión - Farmacia Farmatodo</title>
...
<body>
    ...
    <source src="{{ asset('farmacia.mp4') }}" type="video/mp4"> <!-- Cambia 'video.mp4' por la ruta de tu video -->
    </video>
    ...
    <div class="container-form register">
        ...
        <div class="information">
            <div class="info-childs text-center">
                ...
                <img src="farma.png" alt="Logo 1" width="350">
        ...
        <div class="form-information">
            <div class="form-information-childs">
                ...
                <img src="doctor.jpg" alt="Logo 1" width="350" class="logo-redondo">
