                    ...
                    <div class="card custom-card">
                        <div class="card-body p-5">
                            ...
                            <div class="row gy-3">
                                ...
                                @csrf
                                    <div class="col-xl-12">
                                        <label for="email" class="form-label text-default">Correo electronico</label>
                                        <input type="email" class="form-control form-control-lg" id="email" name="email" placeholder="Correo electronico">
                                    </div>
                                    <div class="col-xl-12 mb-2">
                                        <label for="password" class="form-label text-default d-block">Contraseña<a href="reset-password.html" class="float-end text-danger">Forget password ?</a></label>
                                    ...
                                    <div class="col-xl-12 d-grid mt-2">
                                        <button type="submit" href="index.html" class="btn btn-lg btn-primary">Ingresar</button>
                                    </div>
                                </form>
